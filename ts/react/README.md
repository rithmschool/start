<h1 align="center">
  ...
  A mildly-customized fork of <a href="https://github.com/SafdarJamal/vite-template-react">Vite Template React</a>.
...
To get a local copy of the code, use degit:

```
npm install -g degit    # only need to do this once, ever

degit rithmschool/react-starter my-project-name
cd my-project-name
```
